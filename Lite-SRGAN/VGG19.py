...
def VGG19(
    ...
    x= layers.Activation("relu",name="block1_conv1")(x)

    x = layers.Conv2D(
        64, (3, 3), padding="same", name="block1_conv2_before_activation"
    )(x)

    x= layers.Activation("relu",name="block1_conv2")(x)
    ...
    x= layers.Activation("relu",name="block2_conv1")(x)

    x = layers.Conv2D(
        128, (3, 3), padding="same", name="block2_conv2_before_activation"
    )(x)

    x= layers.Activation("relu",name="block2_conv2")(x)
    ...
    x= layers.Activation("relu",name="block3_conv1")(x)

    x = layers.Conv2D(
        256, (3, 3),  padding="same", name="block3_conv2_before_activation"
    )(x)

    x= layers.Activation("relu",name="block3_conv2")(x)

    x = layers.Conv2D(
        256, (3, 3), padding="same", name="block3_conv3_before_activation"
    )(x)

    x= layers.Activation("relu",name="block3_conv3")(x)

    x = layers.Conv2D(
        256, (3, 3), padding="same", name="block3_conv4_before_activation"
    )(x)

    x= layers.Activation("relu",name="block3_conv4")(x)
    ...
    x= layers.Activation("relu",name="block4_conv1")(x)

    x = layers.Conv2D(
        512, (3, 3), padding="same", name="block4_conv2_before_activation"
    )(x)

    x= layers.Activation("relu",name="block4_conv2")(x)

    x = layers.Conv2D(
        512, (3, 3), padding="same", name="block4_conv3_before_activation"
    )(x)

    x= layers.Activation("relu",name="block4_conv3")(x)

    x = layers.Conv2D(
        512, (3, 3), padding="same", name="block4_conv4_before_activation"
    )(x)

    x= layers.Activation("relu",name="block4_conv4")(x)
    ...
    x= layers.Activation("relu",name="block5_conv1")(x)

    x = layers.Conv2D(
        512, (3, 3), padding="same", name="block5_conv2_before_activation"
    )(x)

    x= layers.Activation("relu",name="block5_conv2")(x)

    x = layers.Conv2D(
        512, (3, 3), padding="same", name="block5_conv3_before_activation"
    )(x)

    x= layers.Activation("relu",name="block5_conv3")(x)

    x = layers.Conv2D(
        512, (3, 3), padding="same", name="block5_conv4_before_activation"
    )(x)

    x= layers.Activation("relu",name="block5_conv4")(x)
